...
// if (!function_exists('getLoggedinPatient')) {
//     /**
//      * @return bool
//      */
//     function getLoggedinPatient()
...
//     function getUserImageInitial($userId, $name)
//     {
//         return getAvatarUrl()."?name=".urlencode($name)."&size=100&rounded=true&color=fff&background=".getRandomColor($userId);
//     }
// }
...
// if (!function_exists('getApiUserImageInitial')) {
//     /**
//      * return avatar full url.
//      *
//      * @param  int  $userId
...
if (!function_exists('isZoomTokenExpire')) {
    function isZoomTokenExpire()
    {
        $zoomOAuth = ZoomOAuth::where('user_id', Auth::id())->first();
        if ($zoomOAuth) {
            $expiresAt = Carbon::parse($zoomOAuth->expires_in);
