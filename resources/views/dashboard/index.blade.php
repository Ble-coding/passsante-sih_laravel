                                ...
                                <a class="text-decoration-none" href="{{ route('invoices.index') }}">
                                    <div
                                        ...
                                        <div class="text-end">
                                            ...
                                            <h3 class="mb-0 fs-5 fw-bold text-dark">{{ __('messages.dashboard.total_invoices') }}
                                            </h3>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="{{ route('payments.index') }}" class="text-decoration-none">
                                    <div
                                        ...
                                        <div class="text-end">
                                            ...
                                            <h3 class="mb-0 fs-5 fw-bold text-dark">{{ __('messages.dashboard.total_payments') }}
                                            </h3>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="{{ route('beds.index') }}" class="text-decoration-none">
                                    <div
                                        ...
                                        <div class="text-end">
                                            ...
                                            <h3 class="mb-0 fs-5 fw-bold text-dark">{{ __('messages.dashboard.available_beds') }}
                                            </h3>
                                        </div>
                                    </div>
                                </a>
